         ...
         function submitForm(){
           ...
           var radioButtons = document.querySelectorAll('input[name="Occupation"]');
            ...
            console.log('send data to server' ,name,selectedGender,qualification,language,email,number,fathername,selectedqualification2,selectedOccupation,mothername,selectedqualification1,address);
            } else {
